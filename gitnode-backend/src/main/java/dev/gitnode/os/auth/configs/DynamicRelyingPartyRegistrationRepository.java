...
public class DynamicRelyingPartyRegistrationRepository
  ...
  public DynamicRelyingPartyRegistrationRepository(
      ...
      @Value("${gitnode.sso.saml.registration-id:saml}") final String legacyRegistrationId,
      @Value("${gitnode.sso.saml.idp-metadata-uri:}") final String legacyMetadataUri,
      @Value("${gitnode.sso.saml.sp-entity-id:gitnode}") final String legacySpEntityId) {
