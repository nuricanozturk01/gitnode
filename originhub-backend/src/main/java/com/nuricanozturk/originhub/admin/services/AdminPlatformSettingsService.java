...
import com.nuricanozturk.originhub.admin.dtos.AdminFeatureTogglesForm;
import com.nuricanozturk.originhub.admin.dtos.AdminPlatformSettingsResponse;
import com.nuricanozturk.originhub.admin.entities.PlatformSetting;
import com.nuricanozturk.originhub.admin.repositories.PlatformSettingRepository;
...
public class AdminPlatformSettingsService {
  ...
  @Value("${originhub.admin.stats.cache-ttl-seconds:300}")
  private long defaultStatsCacheTtlSeconds;

  @Value("${originhub.admin.pgaudit.enabled:false}")
  private boolean defaultPgAuditViewerEnabled;

  @Value("${originhub.admin.modulith-events.enabled:false}")
