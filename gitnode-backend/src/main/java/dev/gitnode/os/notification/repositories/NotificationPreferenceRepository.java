...
public interface NotificationPreferenceRepository
  ...
  Optional<NotificationPreference> findByTenantIdAndType(UUID tenantId, NotificationType type);

  boolean existsByTenantIdAndTypeAndEnabled(UUID tenantId, NotificationType type, boolean enabled);
}
