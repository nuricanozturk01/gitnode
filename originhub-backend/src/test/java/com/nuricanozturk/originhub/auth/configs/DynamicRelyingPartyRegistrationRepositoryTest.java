...
class DynamicRelyingPartyRegistrationRepositoryTest {
  ...
  void findByRegistrationId_returnsOrgRegistration() {
    ...
    final var repository = this.createRepository("saml", "", "originhub");
  ...
  void findByRegistrationId_usesLegacyFallback() {
    ...
    final var repository =
        this.createRepository("saml", "https://idp.example.com/metadata", "originhub");
    ...
    when(registrationBuilder.buildFromLegacy(
            "saml", "https://idp.example.com/metadata", "originhub"))
