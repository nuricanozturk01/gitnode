...
public class PlatformAdminService {
  ...
  public PlatformAdminService(
      @Value("${gitnode.platform.admin-usernames:}") final String adminUsernamesCsv,
      @Value("${gitnode.bootstrap.admin.username:admin}") final String bootstrapAdminUsername,
      @Value("${gitnode.bootstrap.admin.enabled:true}") final boolean bootstrapAdminEnabled) {
