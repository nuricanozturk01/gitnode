...
import (
	...
	"github.com/nuricanozturk/originhub-runner/internal/config"
	"github.com/nuricanozturk/originhub-runner/internal/connection"
	"github.com/nuricanozturk/originhub-runner/internal/executor"
	"github.com/nuricanozturk/originhub-runner/internal/registration"
...
func rootCmd() *cobra.Command {
	root := &cobra.Command{
		Use:     "originhub-runner",
		Short:   "OriginHub CI/CD runner agent",
		Version: version,
	}
...
func startCmd() *cobra.Command {
	...
	cmd.Flags().StringVar(&serverURL, "server-url", "", "OriginHub server URL (e.g. http://localhost:8080)")
...
func defaultWorkDir() string {
	...
	return home + "/.originhub-runner/work"
}
