...
import dev.gitnode.os.tag.dtos.TagInfo;
...
public class TagNonTxService {
  ...
  private static final String TAG_SYSTEM_USER = "GitNode";
  private static final String TAG_SYSTEM_EMAIL = "noreply@gitnode.local";
