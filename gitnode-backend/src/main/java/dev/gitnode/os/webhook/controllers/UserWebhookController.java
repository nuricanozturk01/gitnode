 ...
 */
package dev.gitnode.os.webhook.controllers;
...
import dev.gitnode.os.webhook.services.UserWebhookService;
...
public class UserWebhookController {
  ...
  @PostMapping
  @RateLimit(limit = 10, windowSeconds = 3600, key = "user.webhook.create")
